...
#	 	Then the canidates name to the summary list and add 1 to the vote count
...
Election Data_csv = os.path.join('Resources', 'election_data.csv')
...
with open(Election Data_csv, newline="") as csvfile:
